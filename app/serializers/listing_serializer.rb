class ListingSerializer < ActiveModel::Serializer
  attributes :id, :title, :address, :room_type, :capacity, :description, :household_type, :guest_preference, :pictures, :children, :languages, :user, :provisions, :placements, :longitude, :latitude
